        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text"name="name" id="name" value="{{ old('name') }}" placeholder="Your name"  autocomplete="off"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Your Username" autocomplete="off"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="email" id="email" value="{{ old('email') }}" placeholder="Your Email" autocomplete="off"
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="sr-only">Re-Password again</label>
